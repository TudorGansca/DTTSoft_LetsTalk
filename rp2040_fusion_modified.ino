...
/* Includes ---------------------------------------------------------------- */
#include <LetsTalk_PoliHack_inferencing.h>
...
const int BUTTON_PIN2 = 8, BUTTON_PIN1 = 9, BUTTON_PIN3 = 10;
int sum1, sum2 = 0, maxi = -1;
bool BUTTON_STATE1, BUTTON_STATE2, BUTTON_STATE3;
...
void loop() {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    sum1 = 1 * BUTTON_STATE1 + 2 * BUTTON_STATE2 + 4 * BUTTON_STATE3;
    if (sum1 >= maxi)
      maxi = sum1;
  }
...
void print_inference_result(ei_impulse_result_t result) {
  ...
  //lcd.print(ei_classifier_inferencing_categories[index]);
  lcd.clear();
  lcd.setCursor(0, 0);
  switch (maxi) {
    case 0:
    ...
    case 1:
      ...
      break;
    case 2:
      lcd.print("Button doi");
      break;
    case 3:
      lcd.print("Button 1 + 2");
      break;
    case 4:
      lcd.print("Button 3");
      break;
    case 5:
      lcd.print("Button 1 + 3");
      break;
    case 6:
      lcd.print("Button 2 + 3");
      break;
    case 7:
      lcd.print("Button 1 + 2 + 3");
      break;
  }
  lcd.setCursor(0, 1);
  lcd.print(ei_classifier_inferencing_categories[index]);
